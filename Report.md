...
We break it down to a simple dataset for our purpose to guage whether the idea is feasible or not. We consequently resorted to using the MNIST dataset [2], because the dataset consists of simple, small-sized images with only 1 channel (Black/White).
...
Architecture of text-to-image synthesis [3]
...
How sentences encoded into embedded vectors [4]
...
Using Wasserstein distance in loss function
Iterative batch size reduction
Make the generator stronger as discriminator loss was going to zero.
...
The discriminator which distinguishes between a real and fake sample
The classifier network which classifies the generated output/real output images into one of the 100 classes
...
The results are still not entirely satisfactory. We tried several methods like AC-GAN[5], conditional-GAN and DDGAN as seen above. Unfortunately, we were unable to come up with better results with any of them.
...
Goodfellow, Ian, et al. “Generative Adversarial Networks” arXiv preprint arXiv:1406.2661. 2014. ↩︎

LeCun, Yann, et al. “Gradient-based learning applied to document recognition.” Proceedings of the IEEE, 86(11):2278-2324, 1998. ↩︎

Reed, Scott, et al. “Generative Adversarial Text-to-Image Synthesis” Proceedings of The 33rd International Conference on Machine Learning. 2016. ↩︎

Kiros, Ryan, et al. “Skip-Thought Vectors” arXiv preprint arXiv:1506.06726. 2015. ↩︎

Odena, Augustus, et al. “Conditional Image Synthesis with Auxiliary Classifier GANs” Proceedings of the 34 th International Conference on Machine Learning. 2017. ↩︎
